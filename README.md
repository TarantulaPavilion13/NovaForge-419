...
```bash
# 1. 克隆
git clone https://github.com/TarantulaPavilion13/NovaForge-419
cd NovaForge
...
```bash
git clone https://github.com/TarantulaPavilion13/NovaForge-419.git
cd NovaForge-419
python setup.py
```
...
<!-- Last updated: 2026-06-06 17:39:45 -->
